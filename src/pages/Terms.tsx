  ...
  return (
    ...
    <div className="bg-gradient-warm min-h-screen">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <p className="mb-4 text-center">Last updated: August 29, 2025</p>
        ...
        <ul className="list-disc list-inside space-y-2 mb-6">
          ...
          <li>
            ...
            this Agreement) refers to Rums Enterprise, Pullikadavu Road,
            Perumugham, Feroke, Kozhikode, Kerala 673631.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to sajbiopak, accessible from{" "}
            <a
              href="https://sajbiopak.com/"
